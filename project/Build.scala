...
object Dependencies {
    ...
    val scalatest: ModuleID = "org.scalatest" %% "scalatest" % "2.2.5" % "test"
    ...
    val typechef: ModuleID = "de.fosd.typechef" %% "frontend" % "0.4.2_lift"
...
object SPLlift extends Build {
    ...
    lazy val cspllift = Project(
        ...
        file("CSPLlift"),
        settings = buildSettings ++ Seq(libraryDependencies <+= scalaVersion(kiamaDependency(_)))
    ) dependsOn(cmodule, customization)
